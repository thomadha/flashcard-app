  ...
  async function signIn(email: string, password: string) {
    ...
    if(password.length<6){
      ...
      try{
        ...
        try{
          const loginInfo = await createUserWithEmailAndPassword(auth, email, password); 
          ...
          <div id="LigthPinkPanel">
            <div id="GreenPanel">
              ...
              <form id="InlogField" onSubmit={onSubmit}>
                ...
                /><br />
                <button id="submitButton" type="submit" value="Register">Logg Inn eller registrer</button>
              </form>
            </div>
          </div>
        </div>
